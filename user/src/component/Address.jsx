    ...
    <>
      <form className="container row g-3">
        <div className="col-md-6">
          ...
          <input type="text" className="form-control" ref={nameRef} id="inputName" />
          {nameError && <p className="error-message">{nameError}</p>}
        </div>
        <div className="col-md-6">
          <label htmlFor="inputMobile" className="form-label">Mobile No</label>
          <input type="text" className="form-control" ref={mobileRef} id="inputMobile" />
          {mobileError && <p className="error-message">{mobileError}</p>}
        </div>
        <div className="col-md-6">
          <label htmlFor="inputPincode" className="form-label">Pincode</label>
          <input type="text" className="form-control" ref={pincodeRef} id="inputPincode" />
          {pincodeError && <p className="error-message">{pincodeError}</p>}
        </div>
        <div className="col-md-6">
          <label htmlFor="inputLocality" className="form-label">Locality</label>
          <input type="text" className="form-control" ref={localityRef} id="inputLocality" />
          {localityError && <p className="error-message">{localityError}</p>}
        </div>
        <div className="col-12">
          <label htmlFor="inputAddress" className="form-label">Address</label>
          <input type="text" className="form-control" ref={addressRef} id="inputAddress" />
          {addressError && <p className="error-message">{addressError}</p>}
        </div>
        <div className="col-md-6">
          <label htmlFor="inputCity" className="form-label">City</label>
          <input type="text" className="form-control" ref={cityRef} id="inputCity" />
          {cityError && <p className="error-message">{cityError}</p>}
        </div>
        <div className="col-md-6">
          <label htmlFor="inputState" className="form-label">State</label>
          <input type="text" className="form-control" ref={stateRef} id="inputState" />
