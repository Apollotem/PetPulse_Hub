...
import Cart from "./Cart";  // Import Cart component if it is used here

const Productdetails = () => {
  const { productId } = useParams();
  const id = atob(productId);
  const [isCartVisible, setCartVisible] = useState(false);  // State to manage cart visibility
  ...
  const productFeature = [
    { url: "../images/delivary.png", description: "Fast Delivery" },
    { url: "../images/card.png", description: "Free Shipping" },
    { url: "../images/secure.png", description: "Secure Checkout" },
  ];
  ...
  return (
    <>
      <div className={`topSpacing ${isCartVisible ? 'blurred' : ''}`}>
        {product ? (
          <div className="productDetails-container">
            <div className="left-container">
              {product && <img src={imgPath + product.image} alt="" />}
            ...
            <div className="rigt-container">
              ...
              <div className="addToCart fixedBtn">
                <Link to="#" onClick={toggleCartVisibility}>
                  <ButtonComponent
                    text="ADD TO CART"
                    classs="addbtn smallBtn checkOut"
                    product={product}
              ...
              <div className="sub-headding">Description</div>
              <div className="aboutProductDescription">
                {product && product.description}
              </div>
              <div className="product-featureCOntainer">
                {productFeature.map((feature, index) => (
                  <div className="shipping" key={index}>
                    <img className="featureImage" src={feature.url} alt="" />
                    <div className="feature">{feature.description}</div>
                  </div>
                ))}
              </div>
            </div>
